...
class Vit_effv2(nn.Module):
    def __init__(self, img_size=224,patch_size=16, in_c=1280, num_classes=3,
                 embed_dim=768, repeat=12, num_heads=12,  qkv_bias=True,
                    drop_path_ratio=0.
                 ):
        super(Vit_effv2, self).__init__()
        num_patches = (img_size // patch_size) * (img_size // patch_size)
        self.backbone=EfficientNetv2()
        self.patch_embed = PatchEmbed(in_c=in_c, embed_dim=embed_dim)#[4, 196, 768]
