...
def main(args):
    ...
    net = SwinTransformer(num_classes=3).to(device)#载入网络
    # 迁移学习，权重载入
    ...
    optimizer = optim.AdamW(net.parameters(), lr=args.lr)#优化器设定
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='./st.pth')#保存路径
