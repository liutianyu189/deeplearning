...
import argparse
from model import shffulnetv2_x1_0
...
def main(args):
    ...
    if img_path.split('.')[-1] in supported:#判断是否是单张图片还是文件夹
        ...
        model = shffulnetv2_x1_0(num_classes=args.num_classes).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_weight_path', type=str, default='./shffulnetv2.pth')  # 读取模型路径
