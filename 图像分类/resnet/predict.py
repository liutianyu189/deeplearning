...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_path', type=str, default='./img/level1/a2.jpg')  # 读取图片路径,可设置为图片或者包含图片的文件夹
    parser.add_argument('--model_weight_path', type=str, default='./resnet34.pth')  # 读取模型路径
